...
downloadable Actions artifacts for the Rust CLI on Windows x64 and Linux x64.
Creating a version tag automatically builds the files and publishes them on a
GitHub Release.
